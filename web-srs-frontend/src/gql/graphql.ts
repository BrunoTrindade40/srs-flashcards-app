...
export type GetDueFlashcardsQuery = { __typename?: 'Query', dueFlashcards: Array<{ __typename?: 'Flashcard', id: string, frontContent: string, backContent: string, sourceContext?: string | null }> };
