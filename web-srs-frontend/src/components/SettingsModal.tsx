...
export const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
  ...
  // Invoca o Hook Centralizado (DRY e Memory Leak Safe)
  const modalRef = useFocusTrap(!queryLoading && !!data?.me, onClose);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fadeIn">
      <div
        ...
        role="dialog"
        aria-modal="true"
        className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl flex flex-col gap-6 max-h-[90vh] overflow-y-auto custom-scrollbar"
      >
