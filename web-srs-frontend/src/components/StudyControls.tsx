...
import type { StudyControlsProps } from "./StudyControls.types";

export const StudyControls: React.FC<StudyControlsProps> = ({ onRate }) => (
  <div className="flex flex-wrap md:flex-nowrap w-full gap-3 animate-fadeIn">
    {/* A ausência total da propriedade 'disabled' garante a fluidez máxima (Zero Latency) */}
    <button
      onClick={() => onRate(1)}
